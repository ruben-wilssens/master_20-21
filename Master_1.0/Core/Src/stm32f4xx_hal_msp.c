...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, ADF7242_SCK_Pin|ADF7242_MISO_Pin|ADF7242_MOSI_Pin);
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB10     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(DPOT_MOSI_GPIO_Port, DPOT_MOSI_Pin);

    HAL_GPIO_DeInit(DPOT_SCK_GPIO_Port, DPOT_SCK_Pin);
